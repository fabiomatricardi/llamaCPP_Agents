...
article_list = ["""### 1. Quantum Computing: The Next Frontier in Computational Power
**Introduction**
...
**Conclusion**
Quantum computing is still in its infancy, but it holds the promise of massive computational power. 
The coming decades are likely to see significant advancements in this field as researchers overcome its current limitations.""",
...
res = map_chain.run_map_chain(items_to_map=article_list)
console.print(res)
console.print('------------------------------------------')
console.print(res[1]['out_1'])